...
class SimpleChatAdapter(
    ...
    private fun bindMcpAppCard(holder: McpAppCardViewHolder, card: SubtleCard, position: Int) {
        ...
        var isFavorited = false  // TODO: Track favorite state in preferences
    ...
    private fun bindMcpWebView(holder: McpWebViewHolder, message: ChatMessage) {
        val context = holder.itemView.context
        val webViewData = message.mcpWebViewData ?: return
        
        android.util.Log.d("McpWebView", "Binding WebView for tool: ${webViewData.toolName}")
